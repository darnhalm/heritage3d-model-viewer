...
import { CameraPanel, SkyboxPanel, LightPanel, SettingsPanel, ViewPanel, InfoPanel } from './panels';
...
const PopupPanelControls = (props: { observerData: ObserverData, setProperty: SetProperty }) => {
    return (<>
        <InfoPanel setProperty={props.setProperty} uiData={props.observerData.ui} />
