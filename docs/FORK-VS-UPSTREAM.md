...
Ниже — **сжатое сравнение**. Детальный перечень правок и заметки по безопасности см. в [`CHANGELOG-FORK.md`](./CHANGELOG-FORK.md).
...
| Документация в репозитории | README под апстрим | Дополнительно `docs/`: UI, измерения, состояние и т.д. |
...
- **Левая сворачиваемая панель** — основное место для сцены: вкладки **Settings** (камера, небо, свет, дебаг и др.), **Object Alignment**, **Materials**, **POI**.
