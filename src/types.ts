...
export interface ObserverData {
    ...
    camera: {
        ...
        tilePriority?: 'default' | 'foveated' | 'cursor' | 'surface',
    ...
    debug: {
        ...
        /** Нумеровать порядок загрузки внутри каждого уровня детализации, а не сквозь весь набор. */
        tileOrderPerLod?: boolean,
        /** Показывать в центрах тайлов их идентификаторы вместо порядка загрузки. */
        tileIdLabels?: boolean,
