 ...
 * нет, а сетевой объём ей примерно пропорционален: распаковка обычно даёт 4–10×.
 * 48 Б/px — это ~100 МБ GLB на 1920×1080.
 */
 ...
 * а мобильный профиль пока не проверен. Уточнять его нужно замером на реальном устройстве,
 * а не подбором.
 */
