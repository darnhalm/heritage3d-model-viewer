...
class CameraControls {
    ...
    /**
     * Последняя найденная точка на поверхности под указателем.
     *
     * @returns Точка в мировых координатах или `null`, если под указателем ничего нет.
     */
    get surfaceZoomTarget(): Vec3 | null {
        return this._surfaceZoomPoint;
    }
